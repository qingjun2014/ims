...
public class SelectTeacherByCourse extends HttpServlet {
	protected final Logger log = Logger.getLogger(SelectTeacherByCourse.class.getName());
	/**
	 * Constructor of the object.
	 */
	public SelectTeacherByCourse() {
		super();
	}
